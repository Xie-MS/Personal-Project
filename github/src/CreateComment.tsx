...
function CreateNewIssue() {
  ...
  return (
    <div className="lg:relative flex justify-evenly items-start xl:flex relative mt-4">
        ...
        <div>
          <div className="md:h-auto md:border-[0px] lg:border-[1px] lg:border-solid lg:border-gray-200 lg:rounded-md lg:h-auto lg:mb-2 xl:border-[1px] xl:border-solid xl:border-gray-200 xl:rounded-md xl:h-auto xl:mb-2">
            ...
            <div className="my-2 lg:mx-2 xl:mx-2">
              <div
                className={`block lg:h-[126px] lg:px-0 lg:py-0 border-[1px] border-solid border-gray-400 bg-slate-100 rounded-md w-full relative md:border-0 px-2 py-2 md:h-[126px] xl:h-[126px] xl:px-0 xl:py-0`}
              >
                <div>
                  <textarea
                    cols="30"
              ...
              <div
                className={`hidden px-2 pb-2 w-full min-h-[191px] border-b-[2px] border-solid border-[#d0d7de] md:min-h-[270px]`}
              >
                <p className="text-sm"></p>
                {/* {PreviewText()} */}
              </div>
              <div className="flex justify-end items-center mt-2">
                <div className="flex justify-start items-center bg-[#f6f8fa] mr-2">
                  ...
                  <div className="px-[10px] py-[5px] border-[1px] border-solid border-gray-200 rounded-r-lg h-[32px] w-[40px]">
